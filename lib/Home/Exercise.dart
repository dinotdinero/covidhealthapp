...
import 'package:covidhealthtechapp/Home/product_page.dart';
import 'package:covidhealthtechapp/Models/item.dart';
import 'package:covidhealthtechapp/widgets/loadWidget.dart';
import 'package:covidhealthtechapp/widgets/myDrawer.dart';
import 'package:covidhealthtechapp/widgets/searchBox.dart';
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            "Exercise",
            style: TextStyle(fontSize: 55.0, color: Colors.amber, fontFamily: "Signatra"),
          ),
          centerTitle: true,
...
Widget card({Color primaryColor = Colors.amber, String imgPath}) {
  return Container(
    height: 150.0,
    width: width * .34,
